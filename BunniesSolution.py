# from https://github.com/n3a9/google-foobar/blob/master/Level%204/running_with_bunnies/solution.py
# checked, passes tests still
# saving for later, didn't submit
